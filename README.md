...
Mr Black and Starward both entered Diageo's portfolio through its Distill Ventures accelerator within months of each other, with Mr Black entering in August 2015 and Starward in December 2015. Both were distributed in Iowa through the same third-party importer, Park Street Imports, for their entire recorded history. From there, Diageo's ownership stake in each brand moved in opposite directions.

**Mr Black: stake deepened over time, then distribution stopped.** Diageo's stake grew from roughly 10% in 2015 to 20% in 2017, before Diageo acquired the remaining shares outright on 29 September 2022. In Iowa, Mr Black's retailer coverage was still expanding through the first seven months of 2023 and had already exceeded the total number of new retailers added during 2022. Its last recorded transaction occurred on **26 July 2023**, roughly ten months after full acquisition. No further Iowa purchases appear in the dataset after that date.
...
- **Ownership is only one possible explanation.** Mr Black and Starward share several useful points of comparison, including their connection to Distill Ventures and their Iowa importer, but they still differ in product category, brand maturity, commercial strategy, and potentially other unobserved factors. Iowa's own regulatory process may also matter. As a control state, Iowa's Alcoholic Beverages Division (ABD) is the sole wholesaler for spirits, and a publicly available ABD Listing Manual describes quarterly product delisting reviews using a 12-month sales cycle alongside other product-level criteria. A product could therefore disappear from the Iowa dataset for reasons unrelated to ownership. The available transaction data do not identify the administrative reason for Mr Black's disappearance, so delisting or other state-level distribution decisions cannot be ruled out. The analysis therefore examines whether distribution patterns are *consistent with* differences in ownership structure rather than attributing those patterns to ownership alone.
